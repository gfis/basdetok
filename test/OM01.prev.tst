...
40 IF A$="j" OR A$="J" THEN A%=1: GO TO 50
41 IF A$="n" THEN 50
42 IF A$<>=" " THEN 31
50 CLS
60 SCALE -95,416,0,255
70 KX=39
80 KY=31
90 B$="#"
100 A1=9
...
780 FOR J=1 TO 80
790 A$=INKEY$
800 IF LEN(A$)=0 THEN 830
810 B$=A$
820 GO TO 840
830 NEXT J
840 IF LEN(INKEY$)>0 THEN 840
850 IF X<0 OR X>8 THEN 920
860 ON P(X,Y) GO TO 890,910
...
1270 IF X+DX>7.5 OR X+DX<-.5 THEN 640
1280 X=X+DX
1290 Y=Y+DY
1300 GO TO 640
1310 IF X<0 OR X>7 THEN 640
1315 ON P(X,Y) GO TO 640,640
1320 RETURN
1330 TP=0
1340 TM=0
1350 Z=0
...
2100 ON P(J2,J3) GO TO 2120,2230
2110 RETURN
...
7280 ON P(J6,J7) GO TO 7450,7500
7290 GO TO 7550
7300 NEXT Y
7310 NEXT X
7320 Z=0
